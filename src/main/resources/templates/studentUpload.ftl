...
<div id="tb">
    ...
    <form enctype="multipart/form-data" method="post" action="/excel/uploadStu">
        选择Excel表格：<input type="file" name="file"  /><br /> <input type="submit"
                                                                 value="上传" />

    </form>

    <form enctype="multipart/form-data" method="post" action="/excel/studownload">
...
<table id="dg" class="easyui-datagrid" style="width:400px;height:250px"
       data-options="url:'/stu/queryStuFy',fitColumns:true,fit:true,pagination:true,toolbar:'#tb'">
    <thead>
        <tr>
            ...
            <th data-options="field:'membershipId',width:100">身份编号</th>
